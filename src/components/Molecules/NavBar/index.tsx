...
export const NavBar = () => {
	return (
		<nav className="flex items-center justify-center my-4  text-3xl p-4 font-bangers">
			<Link href="/" className="flex flex-col items-center justify-center my-4">
				<img
					...
					alt=""
				/>
				<p className="text-red-500 ">THE MARVEL BOOK</p>
				<p className="text-red-500 text-xs ">find your favourite heroes!</p>
			</Link>
		</nav>
	);
};
