...
import { HeroCard } from "../../Molecules/HeroesCard";
import { HeroProps } from "../../../utils/interfaces";
import Link from "next/link";

const HeroesList: FC<HeroProps> = ({ ...props }) => {
	return (
		<div className="hover:bg-white border-y border-red-900 rounded-lg duration-300">
			<Link className="w-full h-full" href={`/hero/${props.id}`} key={props.id}>
				<HeroCard
					name={props.name}
